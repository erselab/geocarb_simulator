#!/usr/bin/env python3
"""Keystone-vs-truth-structure control experiment, g_ratio-parametrized
(2026-09-06, user: "Yes please" -- run the same reversal test at finer
g_ratio too). Identical to retrieval_co2palbedo_reversed_truth_
anchorfrozen_gratio1.py except G_RATIO is read from the GRATIO env var.

Original docstring (2026-09-06, user:
...
G_RATIO = os.environ.get("GRATIO", "1")
...
sys.argv = [
    ...
    "--out", str(RESDIR / f"co2palbedo-58-g{gratio_tag}-ad4-pf-anchorfrozen-REVERSEDTRUTH_analytic.pkl"),
]
