...
from geocarb_gert.joint_state import gauss_newton_state as _orig_gn
...
sys.argv = [
    ...
    "--overlap", "0", "--n-workers", "1", "--anchor-workers", "8", "--task-id", "57", "--n-tasks", "58",
    "--out", str(RESDIR / "co2p_albedo-58-g1-ad16-pf-exact-MODE2TRUTH_analytic_verbose.pkl"),
]
